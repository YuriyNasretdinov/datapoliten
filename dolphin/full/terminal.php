...
<head>
	...
	<style>
	body, input, td { background-color: black; font-family: Courier New, Courier, monospace; font-size: 13px; color: rgb(187,187,187); }
	body { margin: 5px; overflow-x: hidden; overflow-y: scroll; }
	input { width: 100%; border: 1px black solid; }
	</style>
