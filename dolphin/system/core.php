...
define('MULTIVIEWS_ENABLED', function_exists('getallheaders') /* Apache-specific function. If Apache is enabled, possibly .htaccess directive Optios +MultiViews is read.. */);
